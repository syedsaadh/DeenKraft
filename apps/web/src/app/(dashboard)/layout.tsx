...
interface NavItem {
  ...
  /** Pathname prefixes that should mark this item as active */
...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
      {/* Sidebar */}
      <aside className="sticky top-0 flex h-screen w-56 shrink-0 flex-col border-r border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        {/* Brand */}
        <div className="flex h-14 items-center border-b border-zinc-200 px-4 dark:border-zinc-800">
          ...
          >
            deenkraft
            <span className="text-zinc-400 dark:text-zinc-500">.studio</span>
          </Link>
        </div>
                ...
                {section.items.map((item) => {
                  ...
                  if (item.disabled) {
                    return (
                      <span
                        key={item.label}
                        className="flex cursor-default items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-zinc-300 dark:text-zinc-600"
                      >
                        {item.icon}
                        {item.label}
                      </span>
